...
## **Project: TGIF Photo Gallery (Web App)**
...
The **TGIF Photo Gallery** is a highly interactive, modern web application designed to showcase curated photographic assets. This document defines both the functional user experience (detailed across 4 progressive iterations) and the non-functional requirements aligned with the five pillars of the **Google Cloud Well-Architected Framework (GCWAF)**.
...
To guarantee enterprise readiness, the architecture of the TGIF Photo Gallery strictly complies with Google Cloud Well-Architected Framework guidelines.
