# AGENTS.md — TGIF Photo Gallery Workspace Router & Protocol

Welcome, Agent. This is the canonical developer router and source of truth for the TGIF Photo Gallery project. Read and execute on these guidelines flawlessly.
...
* **Current Issue:** None (Project setup / Greenfield phase).
* **Next Available Feature:** **[US1] Responsive Photo Grid** (to bootstrap the pure core engine and the initial responsive grid UI).
* **Dev Server Command:** `.venv/bin/python src/gallery/shell/server.py` (Runs on port `8080` once the project structure is scaffolded).